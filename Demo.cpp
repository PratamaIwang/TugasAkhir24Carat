...
//	model = glm::scale(model, glm::vec3(3, 1, 5));
...
void Demo::BuildColoredPlane()
{
	...
	GLfloat vertices[] = {
		...
		// back
		-20.0, -0.5, -20.0,  0,  0, //4
		-20.0, 20.5, -20.0, 20,  0, //5
		 20.0, 20.5, -20.0, 20, 20, //6
		 20.0, -0.5, -20.0,  0, 20, //7

	};

	GLuint indices[] = { 0,  2,  1,  0,  3,  2,  4,  6,  5,  4,  7,  6, };
...
void Demo::DrawWoods(double posX, double posY, double posZ, double scX, double scY, double scZ)
{
	UseShader(shaderProgram);
	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, texture3);
...
void Demo::DrawBlanket()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0.5, 1, 0));
	model = glm::scale(model, glm::vec3(2.75, 0.5, 2));
...
void Demo::DrawPillow()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-1.35, 1, 0));
	model = glm::scale(model, glm::vec3(1, 0.5, 2));
